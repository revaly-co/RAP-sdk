...
namespace Revaly.Sdk.Core.Model
{
    ...
    public partial class RefundRequest : IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="merchantTransactionId">Merchant-provided unique identifier for this refund transaction</param>
        ...
        [JsonConstructor]
        public RefundRequest(string merchantTransactionId, Option<long?> amount = default)
        {
        ...
        /// </summary>
        /// <value>Merchant-provided unique identifier for this refund transaction</value>
    ...
    public class RefundRequestJsonConverter : JsonConverter<RefundRequest>
    {
        ...
        public override RefundRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!merchantTransactionId.IsSet)
                throw new ArgumentException("Property is required for class RefundRequest.", nameof(merchantTransactionId));

            if (merchantTransactionId.IsSet && merchantTransactionId.Value == null)
                throw new ArgumentNullException(nameof(merchantTransactionId), "Property is not nullable for class RefundRequest.");

            return new RefundRequest(merchantTransactionId.Value!, amount);
        }
        ...
        {
            if (refundRequest.MerchantTransactionId == null)
                throw new ArgumentNullException(nameof(refundRequest.MerchantTransactionId), "Property is required for class RefundRequest.");

            writer.WriteString("merchantTransactionId", refundRequest.MerchantTransactionId);

            if (refundRequest.AmountOption.IsSet)
                if (refundRequest.AmountOption.Value != null)
                    writer.WriteNumber("amount", refundRequest.AmountOption.Value!.Value);
                else
