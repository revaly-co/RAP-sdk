...
from revaly_sdk_core.api_response import ApiResponse, T as ApiResponseT
import revaly_sdk_core.models
from revaly_sdk_core import rest
from revaly_sdk_core.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
...
class ApiClient:
    ...
    def __init__(
        ...
        self.user_agent = 'revaly-sdk-python/0.0.0-unwrapped-core'
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(revaly_sdk_core.models, klass)
