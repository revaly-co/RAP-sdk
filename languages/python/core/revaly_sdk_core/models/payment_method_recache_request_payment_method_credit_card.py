...
class PaymentMethodRecacheRequestPaymentMethodCreditCard(BaseModel):
    """
    Credit card data for verification
    """ # noqa: E501
    verification_value: Annotated[str, Field(strict=True)] = Field(description="CVV/CVC code for verification", alias="verificationValue", json_schema_extra={"examples": ["123"]})
    __properties: ClassVar[List[str]] = ["verificationValue"]

    @field_validator('verification_value')
    def verification_value_validate_regular_expression(cls, value):
