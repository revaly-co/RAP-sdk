...
class TransactionGroupResponse(BaseModel):
    ...
    """ # noqa: E501
    transaction: Optional[TransactionResponse] = Field(default=None, description="The transaction matching the supplied id (the record the non-expanded lookup returns).")
    transactions: Optional[List[TransactionResponse]] = Field(default=None, description="Every transaction in the payment, ordered by transaction date ascending. Capped at 100.")
    __properties: ClassVar[List[str]] = ["transaction", "transactions"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "transaction": TransactionResponse.from_dict(obj["transaction"]) if obj.get("transaction") is not None else None,
