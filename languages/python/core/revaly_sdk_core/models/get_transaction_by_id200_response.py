...
GETTRANSACTIONBYID200RESPONSE_ANY_OF_SCHEMAS = ["TransactionGroupResponse", "TransactionResponse"]
...
class GetTransactionById200Response(BaseModel):
    ...
    anyof_schema_1_validator: Optional[TransactionGroupResponse] = None
    # data type: TransactionResponse
    anyof_schema_2_validator: Optional[TransactionResponse] = None
    if TYPE_CHECKING:
        actual_instance: Optional[Union[TransactionGroupResponse, TransactionResponse]] = None
    else:
        actual_instance: Any = None
    any_of_schemas: Set[str] = { "TransactionGroupResponse", "TransactionResponse" }
    ...
    def actual_instance_must_validate_anyof(cls, v):
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when setting the actual_instance in GetTransactionById200Response with anyOf schemas: TransactionGroupResponse, TransactionResponse. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when deserializing the JSON string into GetTransactionById200Response with anyOf schemas: TransactionGroupResponse, TransactionResponse. Details: " + ", ".join(error_messages))
        else:
            return instance
