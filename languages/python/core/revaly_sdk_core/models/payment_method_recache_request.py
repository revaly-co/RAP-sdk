...
class PaymentMethodRecacheRequest(BaseModel):
    """
    Request to recache a payment method
    """ # noqa: E501
    payment_method: PaymentMethodRecacheRequestPaymentMethod = Field(alias="paymentMethod")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "paymentMethod": PaymentMethodRecacheRequestPaymentMethod.from_dict(obj["paymentMethod"]) if obj.get("paymentMethod") is not None else None
        })
        return _obj
