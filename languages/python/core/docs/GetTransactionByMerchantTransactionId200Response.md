...
json = "{}"
# create an instance of GetTransactionByMerchantTransactionId200Response from a JSON string
get_transaction_by_merchant_transaction_id200_response_instance = GetTransactionByMerchantTransactionId200Response.from_json(json)
# print the JSON string representation of the object
print(GetTransactionByMerchantTransactionId200Response.to_json())

# convert the object into a dict
get_transaction_by_merchant_transaction_id200_response_dict = get_transaction_by_merchant_transaction_id200_response_instance.to_dict()
# create an instance of GetTransactionByMerchantTransactionId200Response from a dict
get_transaction_by_merchant_transaction_id200_response_from_dict = GetTransactionByMerchantTransactionId200Response.from_dict(get_transaction_by_merchant_transaction_id200_response_dict)
```
