...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://api.revaly.co';
     ...
     * @var string
     */
    protected $userAgent = 'revaly-sdk-php/0.0.0-unwrapped-core';
    ...
    {
        $report  = 'PHP SDK (Revaly\Sdk\Core) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . PHP_VERSION . PHP_EOL;
        $report .= '    The version of the OpenAPI document: 2.2.1' . PHP_EOL;
