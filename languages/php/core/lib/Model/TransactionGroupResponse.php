 ...
 *
 * @category Class
 * @description Envelope returned by the V2 transaction-details lookups when &#x60;includeAllTransactions&#x3D;true&#x60;. Contains the matched transaction plus every transaction belonging to the same payment — all attempts and lifecycle operations (capture, refund, void) that share the same initial transaction id. If the matched transaction has no initial transaction id, &#x60;transactions&#x60; contains only the matched record.
 * @package  Revaly\Sdk\Core
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
