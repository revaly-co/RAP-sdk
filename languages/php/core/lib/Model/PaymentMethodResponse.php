 ...
 *
 * @category Class
 * @description Payment method information associated with a transaction
 * @package  Revaly\Sdk\Core
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class PaymentMethodResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setPaymentMethodId($payment_method_id)
    {
        ...
        if (!is_null($payment_method_id) && (mb_strlen($payment_method_id) > 50)) {
            throw new \InvalidArgumentException('invalid length for $payment_method_id when calling PaymentMethodResponse., must be smaller than or equal to 50.');
        }
        if (!is_null($payment_method_id) && (mb_strlen($payment_method_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $payment_method_id when calling PaymentMethodResponse., must be bigger than or equal to 1.');
        }
     ...
     * Sets expiry_month
     *
     * @param string|null $expiry_month Credit card expiry month
     *
     * @return self
     */
    public function setExpiryMonth($expiry_month)
    {
        ...
        if (!is_null($expiry_month) && (!preg_match("/^(0[1-9]|1[0-2])$/", ObjectSerializer::toString($expiry_month)))) {
            throw new \InvalidArgumentException("invalid value for \$expiry_month when calling PaymentMethodResponse., must conform to the pattern /^(0[1-9]|1[0-2])$/.");
        }
     ...
     * Sets expiry_year
     *
     * @param string|null $expiry_year Credit card expiry year
     *
     * @return self
     */
    public function setExpiryYear($expiry_year)
    {
        ...
        if (!is_null($expiry_year) && (!preg_match("/^20[0-9]{2}$/", ObjectSerializer::toString($expiry_year)))) {
            throw new \InvalidArgumentException("invalid value for \$expiry_year when calling PaymentMethodResponse., must conform to the pattern /^20[0-9]{2}$/.");
        }
     ...
     * Sets cvv
     *
     * @param string|null $cvv Masked card verification value
     *
     * @return self
     */
     ...
     * Sets full_name
     *
     * @param string|null $full_name Cardholder's full name
     *
     * @return self
     */
    ...
    public function setLastFourDigits($last_four_digits)
    {
        ...
        if (!is_null($last_four_digits) && (!preg_match("/^[0-9]{4}$/", ObjectSerializer::toString($last_four_digits)))) {
            throw new \InvalidArgumentException("invalid value for \$last_four_digits when calling PaymentMethodResponse., must conform to the pattern /^[0-9]{4}$/.");
        }
     ...
     *
     * @param string|null $first_six_digits First six digits of the payment method (BIN)
     *
     * @return self
     */
    public function setFirstSixDigits($first_six_digits)
    {
        ...
        if (!is_null($first_six_digits) && (!preg_match("/^[0-9]{6}$/", ObjectSerializer::toString($first_six_digits)))) {
            throw new \InvalidArgumentException("invalid value for \$first_six_digits when calling PaymentMethodResponse., must conform to the pattern /^[0-9]{6}$/.");
        }
    ...
    public function setBin($bin)
    {
        ...
        if (!is_null($bin) && (!preg_match("/^(?:[0-9]{6}|[0-9]{8})$/", ObjectSerializer::toString($bin)))) {
            throw new \InvalidArgumentException("invalid value for \$bin when calling PaymentMethodResponse., must conform to the pattern /^(?:[0-9]{6}|[0-9]{8})$/.");
        }
