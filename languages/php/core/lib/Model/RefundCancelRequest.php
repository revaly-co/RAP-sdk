...
/**
 * RefundCancelRequest Class Doc Comment
 *
 * @category Class
 * @description Request to refund or cancel a payment transaction using merchant transaction ID
 * @package  Revaly\Sdk\Core
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class RefundCancelRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'RefundCancelRequest';
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['merchant_transaction_id']) > 50)) {
            $invalidProperties[] = "invalid value for 'merchant_transaction_id', the character length must be smaller than or equal to 50.";
        }
     ...
     *
     * @param string $merchant_transaction_id Merchant-provided unique identifier for this refund/cancel transaction
     *
     * @return self
     */
    public function setMerchantTransactionId($merchant_transaction_id)
    {
        ...
        if ((mb_strlen($merchant_transaction_id) > 50)) {
            throw new \InvalidArgumentException('invalid length for $merchant_transaction_id when calling RefundCancelRequest., must be smaller than or equal to 50.');
        }
     ...
     * Sets amount
     *
     * @param int|null $amount Refund amount in smallest currency unit (e.g., cents for USD). If null or omitted, a full refund will be processed.
     *
     * @return self
     */
    public function setAmount($amount)
    {
        ...
        if (!is_null($amount) && ($amount < 0)) {
            throw new \InvalidArgumentException('invalid value for $amount when calling RefundCancelRequest., must be bigger than or equal to 0.');
        }
     ...
     * Sets customer_id
     *
     * @param string $customer_id Unique identifier of the customer associated with this transaction
     *
     * @return self
     */
    public function setCustomerId($customer_id)
    {
        ...
        if ((mb_strlen($customer_id) > 50)) {
            throw new \InvalidArgumentException('invalid length for $customer_id when calling RefundCancelRequest., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($customer_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $customer_id when calling RefundCancelRequest., must be bigger than or equal to 1.');
        }
