 ...
 *
 * @category Class
 * @description Request to refund a payment transaction
 * @package  Revaly\Sdk\Core
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class RefundRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     *
     * @param string $merchant_transaction_id Merchant-provided unique identifier for this refund transaction
     *
     * @return self
     */
    public function setMerchantTransactionId($merchant_transaction_id)
    {
        ...
        if ((mb_strlen($merchant_transaction_id) > 100)) {
            throw new \InvalidArgumentException('invalid length for $merchant_transaction_id when calling RefundRequest., must be smaller than or equal to 100.');
        }
