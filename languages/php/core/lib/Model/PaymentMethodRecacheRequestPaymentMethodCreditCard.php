...
/**
 * PaymentMethodRecacheRequestPaymentMethodCreditCard Class Doc Comment
 *
 * @category Class
 * @description Credit card data for verification
 * @package  Revaly\Sdk\Core
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class PaymentMethodRecacheRequestPaymentMethodCreditCard implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'PaymentMethodRecacheRequest_paymentMethod_creditCard';
    ...
    public function listInvalidProperties()
    {
        ...
        if (!preg_match("/^[0-9]{3,4}$/", $this->container['verification_value'])) {
            $invalidProperties[] = "invalid value for 'verification_value', must be conform to the pattern /^[0-9]{3,4}$/.";
        }
     ...
     *
     * @param string $verification_value CVV/CVC code for verification
     *
     * @return self
     */
    public function setVerificationValue($verification_value)
    {
        ...
        if ((!preg_match("/^[0-9]{3,4}$/", ObjectSerializer::toString($verification_value)))) {
            throw new \InvalidArgumentException("invalid value for \$verification_value when calling PaymentMethodRecacheRequestPaymentMethodCreditCard., must conform to the pattern /^[0-9]{3,4}$/.");
        }
