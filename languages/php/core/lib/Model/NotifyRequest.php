...
/**
 * NotifyRequest Class Doc Comment
 *
 * @category Class
 * @description Notification request to inform Revaly of specific business events
 * @package  Revaly\Sdk\Core
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class NotifyRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'NotifyRequest';
    ...
    protected static $openAPITypes = [
        'event_type' => 'string',
        'data' => '\Revaly\Sdk\Core\Model\NotifyData'
    ];
    ...
    public const EVENT_TYPE_RECORD_PAYMENT = 'recordPayment';
    public const EVENT_TYPE_RECORD_REFUND = 'recordRefund';
    public const EVENT_TYPE_RECORD_CHARGEBACK = 'recordChargeback';
    public const EVENT_TYPE_END_OUTREACH = 'endOutreach';
    public const EVENT_TYPE_UPDATE_CUSTOMER_DATA = 'updateCustomerData';
    ...
    {
        return [
            self::EVENT_TYPE_RECORD_PAYMENT,
            self::EVENT_TYPE_RECORD_REFUND,
            self::EVENT_TYPE_RECORD_CHARGEBACK,
            self::EVENT_TYPE_END_OUTREACH,
            self::EVENT_TYPE_UPDATE_CUSTOMER_DATA,
     ...
     * Sets event_type
     *
     * @param string $event_type Type of business event being reported. The event type determines how Revaly processes the notification.  - **recordPayment**: Record a payment transaction - **recordRefund**: Record a refund transaction - **recordChargeback**: Record a chargeback on a transaction - **endOutreach**: End an outreach campaign for a customer - **updateCustomerData**: Update customer information and contact details
     *
     * @return self
     */
     ...
     * Gets data
     *
     * @return \Revaly\Sdk\Core\Model\NotifyData|null
     */
     ...
     * Sets data
     *
     * @param \Revaly\Sdk\Core\Model\NotifyData|null $data data
     *
     * @return self
     */
