 ...
 *
 * @category Class
 * @description Request to capture an authorized payment transaction
 * @package  Revaly\Sdk\Core
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class CaptureRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     *
     * @param string $merchant_transaction_id Merchant-provided unique identifier for this capture transaction
     *
     * @return self
     */
    public function setMerchantTransactionId($merchant_transaction_id)
    {
        ...
        if ((mb_strlen($merchant_transaction_id) > 100)) {
            throw new \InvalidArgumentException('invalid length for $merchant_transaction_id when calling CaptureRequest., must be smaller than or equal to 100.');
        }
     ...
     * Sets amount
     *
     * @param int|null $amount Capture amount in smallest currency unit (e.g., cents for USD). If null or omitted, the full authorized amount will be captured.
     *
     * @return self
     */
    public function setAmount($amount)
    {
        ...
        if (!is_null($amount) && ($amount < 0)) {
            throw new \InvalidArgumentException('invalid value for $amount when calling CaptureRequest., must be bigger than or equal to 0.');
        }
