...
/**
 * StoredCredentialReasonType Class Doc Comment
 *
 * @category Class
 * @description Indicates the reason for using a stored credential: - **unscheduled**: An unscheduled transaction using stored credentials - **recurring**: A recurring payment using stored credentials - **installment**: An installment payment using stored credentials
 * @package  Revaly\Sdk\Core
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class StoredCredentialReasonType
{
    /**
