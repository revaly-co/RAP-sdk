...
/**
 * NotifyResponse Class Doc Comment
 *
 * @category Class
 * @description Response to a notification request indicating processing status
 * @package  Revaly\Sdk\Core
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class NotifyResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'NotifyResponse';
     ...
     * Sets success
     *
     * @param bool|null $success Indicates whether the notification was processed successfully
     *
     * @return self
     */
     ...
     * Sets message
     *
     * @param string|null $message Human-readable message about the notification processing result
     *
     * @return self
     */
