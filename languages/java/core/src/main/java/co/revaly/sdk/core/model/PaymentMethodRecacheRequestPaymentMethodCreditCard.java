 ...
 */
@JsonPropertyOrder({
  PaymentMethodRecacheRequestPaymentMethodCreditCard.JSON_PROPERTY_VERIFICATION_VALUE
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.23.0")
public class PaymentMethodRecacheRequestPaymentMethodCreditCard {
  public static final String JSON_PROPERTY_VERIFICATION_VALUE = "verificationValue";
  @javax.annotation.Nonnull
  private String verificationValue;

  public PaymentMethodRecacheRequestPaymentMethodCreditCard() { 
  }

  public PaymentMethodRecacheRequestPaymentMethodCreditCard verificationValue(@javax.annotation.Nonnull String verificationValue) {
   ...
   */
  @javax.annotation.Nonnull
  @JsonProperty(value = JSON_PROPERTY_VERIFICATION_VALUE, required = true)
  ...
  @JsonProperty(value = JSON_PROPERTY_VERIFICATION_VALUE, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setVerificationValue(@javax.annotation.Nonnull String verificationValue) {
    this.verificationValue = verificationValue;
  }


  /**
   * Return true if this PaymentMethodRecacheRequest_paymentMethod_creditCard object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PaymentMethodRecacheRequestPaymentMethodCreditCard paymentMethodRecacheRequestPaymentMethodCreditCard = (PaymentMethodRecacheRequestPaymentMethodCreditCard) o;
    return Objects.equals(this.verificationValue, paymentMethodRecacheRequestPaymentMethodCreditCard.verificationValue);
  }

  @Override
  public int hashCode() {
    return Objects.hash(verificationValue);
  }
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `verificationValue` to the URL query string
    if (getVerificationValue() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sverificationValue%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getVerificationValue()))));
    }
