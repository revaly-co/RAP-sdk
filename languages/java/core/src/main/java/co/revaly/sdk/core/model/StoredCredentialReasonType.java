...
public enum StoredCredentialReasonType {
  ...
  StoredCredentialReasonType(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static StoredCredentialReasonType fromValue(String value) {
    for (StoredCredentialReasonType b : StoredCredentialReasonType.values()) {
