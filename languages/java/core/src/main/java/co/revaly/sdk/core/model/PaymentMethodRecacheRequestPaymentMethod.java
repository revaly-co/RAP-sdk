...
import co.revaly.sdk.core.model.PaymentMethodRecacheRequestPaymentMethodCreditCard;
 ...
 */
@JsonPropertyOrder({
  PaymentMethodRecacheRequestPaymentMethod.JSON_PROPERTY_CREDIT_CARD
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.23.0")
public class PaymentMethodRecacheRequestPaymentMethod {
  public static final String JSON_PROPERTY_CREDIT_CARD = "creditCard";
  @javax.annotation.Nonnull
  private PaymentMethodRecacheRequestPaymentMethodCreditCard creditCard;

  public PaymentMethodRecacheRequestPaymentMethod() { 
  }

  public PaymentMethodRecacheRequestPaymentMethod creditCard(@javax.annotation.Nonnull PaymentMethodRecacheRequestPaymentMethodCreditCard creditCard) {
  ...
  public PaymentMethodRecacheRequestPaymentMethodCreditCard getCreditCard() {
    return creditCard;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_CREDIT_CARD, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setCreditCard(@javax.annotation.Nonnull PaymentMethodRecacheRequestPaymentMethodCreditCard creditCard) {
    this.creditCard = creditCard;
  }


  /**
   * Return true if this PaymentMethodRecacheRequest_paymentMethod object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PaymentMethodRecacheRequestPaymentMethod paymentMethodRecacheRequestPaymentMethod = (PaymentMethodRecacheRequestPaymentMethod) o;
    return Objects.equals(this.creditCard, paymentMethodRecacheRequestPaymentMethod.creditCard);
  }
