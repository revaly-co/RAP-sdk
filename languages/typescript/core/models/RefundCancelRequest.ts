...
/**
 * Check if a given object implements the RefundCancelRequest interface.
 */
export function instanceOfRefundCancelRequest(value: object): value is RefundCancelRequest {
    if (!('merchantTransactionId' in value) || value['merchantTransactionId'] === undefined) return false;
    if (!('customerId' in value) || value['customerId'] === undefined) return false;
    return true;
}

export function RefundCancelRequestFromJSON(json: any): RefundCancelRequest {
    return RefundCancelRequestFromJSONTyped(json, false);
}

export function RefundCancelRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): RefundCancelRequest {
    if (json == null) {
        return json;
    }
    return {
...
export function RefundCancelRequestToJSON(json: any): RefundCancelRequest {
    return RefundCancelRequestToJSONTyped(json, false);
}

export function RefundCancelRequestToJSONTyped(value?: RefundCancelRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
