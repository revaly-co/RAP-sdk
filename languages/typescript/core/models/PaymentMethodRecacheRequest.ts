...
import type { PaymentMethodRecacheRequestPaymentMethod } from './PaymentMethodRecacheRequestPaymentMethod';
import {
    PaymentMethodRecacheRequestPaymentMethodFromJSON,
    PaymentMethodRecacheRequestPaymentMethodFromJSONTyped,
    PaymentMethodRecacheRequestPaymentMethodToJSON,
    PaymentMethodRecacheRequestPaymentMethodToJSONTyped,
} from './PaymentMethodRecacheRequestPaymentMethod';

/**
 * Request to recache a payment method
 * @export
 * @interface PaymentMethodRecacheRequest
 */
export interface PaymentMethodRecacheRequest {
    /**
     * 
     * @type {PaymentMethodRecacheRequestPaymentMethod}
     * @memberof PaymentMethodRecacheRequest
     */
    paymentMethod: PaymentMethodRecacheRequestPaymentMethod;
}

/**
 * Check if a given object implements the PaymentMethodRecacheRequest interface.
 */
export function instanceOfPaymentMethodRecacheRequest(value: object): value is PaymentMethodRecacheRequest {
    if (!('paymentMethod' in value) || value['paymentMethod'] === undefined) return false;
    return true;
}

export function PaymentMethodRecacheRequestFromJSON(json: any): PaymentMethodRecacheRequest {
    return PaymentMethodRecacheRequestFromJSONTyped(json, false);
}

export function PaymentMethodRecacheRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): PaymentMethodRecacheRequest {
    if (json == null) {
        return json;
    }
    return {
        
        'paymentMethod': PaymentMethodRecacheRequestPaymentMethodFromJSON(json['paymentMethod']),
    };
}

export function PaymentMethodRecacheRequestToJSON(json: any): PaymentMethodRecacheRequest {
    return PaymentMethodRecacheRequestToJSONTyped(json, false);
}

export function PaymentMethodRecacheRequestToJSONTyped(value?: PaymentMethodRecacheRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'paymentMethod': PaymentMethodRecacheRequestPaymentMethodToJSON(value['paymentMethod']),
    };
}
