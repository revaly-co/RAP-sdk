 ...
 * @export
 */
export type GetTransactionById200Response = TransactionGroupResponse | TransactionResponse;

export function GetTransactionById200ResponseFromJSON(json: any): GetTransactionById200Response {
    return GetTransactionById200ResponseFromJSONTyped(json, false);
}

export function GetTransactionById200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): GetTransactionById200Response {
    if (json == null) {
        return json;
    }
...
export function GetTransactionById200ResponseToJSON(json: any): any {
    return GetTransactionById200ResponseToJSONTyped(json, false);
}

export function GetTransactionById200ResponseToJSONTyped(value?: GetTransactionById200Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
