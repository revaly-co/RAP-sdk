...
export function GatewayPaymentMethodFromJSON(json: any): GatewayPaymentMethod {
    return GatewayPaymentMethodFromJSONTyped(json, false);
}

export function GatewayPaymentMethodFromJSONTyped(json: any, ignoreDiscriminator: boolean): GatewayPaymentMethod {
    if (json == null) {
        return json;
    }
    return {
...
export function GatewayPaymentMethodToJSON(json: any): GatewayPaymentMethod {
    return GatewayPaymentMethodToJSONTyped(json, false);
}

export function GatewayPaymentMethodToJSONTyped(value?: GatewayPaymentMethod | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
