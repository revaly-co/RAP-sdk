...
export function TransactionGatewayFromJSON(json: any): TransactionGateway {
    return TransactionGatewayFromJSONTyped(json, false);
}

export function TransactionGatewayFromJSONTyped(json: any, ignoreDiscriminator: boolean): TransactionGateway {
    if (json == null) {
        return json;
    }
    return {
...
export function TransactionGatewayToJSON(json: any): TransactionGateway {
    return TransactionGatewayToJSONTyped(json, false);
}

export function TransactionGatewayToJSONTyped(value?: TransactionGateway | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
