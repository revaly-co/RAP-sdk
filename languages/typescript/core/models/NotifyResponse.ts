...
export function NotifyResponseFromJSON(json: any): NotifyResponse {
    return NotifyResponseFromJSONTyped(json, false);
}

export function NotifyResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): NotifyResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function NotifyResponseToJSON(json: any): NotifyResponse {
    return NotifyResponseToJSONTyped(json, false);
}

export function NotifyResponseToJSONTyped(value?: NotifyResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
