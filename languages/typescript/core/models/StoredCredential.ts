...
export function StoredCredentialFromJSONTyped(json: any, ignoreDiscriminator: boolean): StoredCredential {
    ...
    return {
        ...
        'initialGatewayTransactionId': json['initialGatewayTransactionId'] == null ? undefined : json['initialGatewayTransactionId'],
        'latestGatewayTransactionId': json['latestGatewayTransactionId'] == null ? undefined : json['latestGatewayTransactionId'],
    };
}
...
export function StoredCredentialToJSONTyped(value?: StoredCredential | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'initialGatewayTransactionId': value['initialGatewayTransactionId'],
        'latestGatewayTransactionId': value['latestGatewayTransactionId'],
    };
}
