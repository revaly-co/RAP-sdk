...
------------ | ------------- | ------------- | -------------
**Address1** | Pointer to **NullableString** | Primary address line | [optional] 
**Address2** | Pointer to **NullableString** | Secondary address line (apartment, suite, etc.) | [optional] 
**City** | Pointer to **NullableString** | City name | [optional] 
**State** | Pointer to **NullableString** | State or province code | [optional] 
**Zip** | Pointer to **NullableString** | Postal or ZIP code | [optional] 
**Country** | Pointer to **NullableString** | Country code (ISO 3166-1 alpha-2) | [optional] 
**PhoneNumber** | Pointer to **NullableString** | Phone number associated with the address | [optional] 
...
`func (o *Address) SetZipNil(b bool)`
...
`func (o *Address) SetPhoneNumberNil(b bool)`
